                                ...
                                <div class="card border-0 rounded-0 text-light overflow zoom">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                            <!--title-->
                                            <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                                <h2 class="h5 post-title text-white my-1">Bootstrap 4 template news portal magazine perfect for news site</h2>
                                            </a>
                                            <!-- meta title -->
                                            <div class="news-meta">
                            ...
                            <div class="card border-0 rounded-0 text-white overflow zoom">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                        ...
                                        <!--title-->
                                        <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                            <h2 class="font-size text-white my-1">Should you see the Fantastic Beasts sequel?</h2>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded-0 text-white overflow zoom">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                        ...
                                        <!--title-->
                                        <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                            <h2 class="font-size text-white my-1">Three myths about Florida elections recount</h2>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded-0 text-white overflow zoom">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                        ...
                                        <!--title-->
                                        <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                            <h2 class="font-size text-white my-1">Finding Empowerment in Two Wheels and a Helmet</h2>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 rounded-0 text-white overflow zoom">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                        ...
                                        <!--title-->
                                        <a href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">
                                            <h2 class="font-size text-white my-1">Ditch receipts and four other tips to be a shopper</h2>
                                        </a>
                                    </div>
                                </div>
                            </div>
